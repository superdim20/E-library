                ...
                <div class="card-body">
                    <form action="{{ route('publisher.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_publisher') is-invalid @enderror" name="nama_publisher"
                                value="{{ old('nama_publisher') }}" placeholder="publisher Name" required>
